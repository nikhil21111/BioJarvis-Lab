      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center relative overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <svg className="w-48 h-[500px] opacity-30" viewBox="0 0 100 400">
            <defs>
              <linearGradient id="dnaGradSignup" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{stopColor: '#10b981', stopOpacity: 0.8}} />
                <stop offset="50%" style={{stopColor: '#10b981', stopOpacity: 0.3}} />
                <stop offset="100%" style={{stopColor: '#10b981', stopOpacity: 0.8}} />
              </linearGradient>
            </defs>
            <path d="M20,0 Q80,50 20,100 Q-40,150 20,200 Q80,250 20,300 Q-40,350 20,400" fill="none" stroke="url(#dnaGradSignup)" strokeWidth="1.5" />
            <path d="M80,0 Q20,50 80,100 Q140,150 80,200 Q20,250 80,300 Q140,350 80,400" fill="none" stroke="url(#dnaGradSignup)" strokeWidth="1.5" />
          ...
          <div className="mt-16 text-center">
            <p className="mono-font text-[10px] uppercase tracking-[0.3em] text-emerald-500/60 mb-3">New Sequence Initialization</p>
            <p className="serif-font text-2xl italic opacity-40">Access Protocol</p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-16 relative">
        <div className="w-full max-w-md">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-4xl serif-font italic font-light">Create your<br />Lab Access.</h1>
          </div>
